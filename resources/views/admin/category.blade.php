@if (($admin == true) && ($accessLevel < 3) && ($accessLevel > 0))
    ...
    @section('content')
        <div>
            ...
            <hr>
            <div class="mt-4 row">
                <button style="max-width: 100%" type="button" class="btn btn-outline-success" data-bs-toggle="modal"
                ...
                @foreach ($data as $item)
                    <div class="row">
                        ...
                        <button type="button" class="btn btn-outline-success col-md-2" data-bs-toggle="modal"
                                data-bs-target="#charModal-{{ $item->id }}">Characteristics
                        </button>
                        <div class="modal fade" id="charModal-{{ $item->id }}" tabindex="-1"
                             aria-labelledby="charModalLabel-{{ $item->tittle }}" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-dark">
                                        <div>
                                            <a class="row" href="{{ route('admCategoriesChar', $item->id) }}">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{ route('removeCategory', $item->id) }}">
                                            <button method="GET" type="button" class="btn btn-outline-danger">Remove
                                            </button>
                                        </a>
                                    </div>
                                </div>
